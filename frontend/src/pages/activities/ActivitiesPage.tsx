...
export function ActivitiesPage() {
  ...
  const createMutation = useMutation({
    mutationFn: (d: ActivityCreate) => activitiesService.create(d),
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, d }: { id: number; d: ActivityUpdate }) => activitiesService.update(id, d),
...
function ActivityFormDialog({ open, onClose, onSubmit, loading, title, defaultValues, isEdit = false }: any) {
